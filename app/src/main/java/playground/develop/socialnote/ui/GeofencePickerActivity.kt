...
class GeofencePickerActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun addMarker(latLng: LatLng) {
        ...
        val locationCircle = mMap
            .addCircle(CircleOptions().center(latLng).radius(GEOFENCE_REMINDER_MAP_RADIUS).strokeColor(ContextCompat.getColor(this@GeofencePickerActivity, R.color.circle_stroke_color)).fillColor(ContextCompat.getColor(this@GeofencePickerActivity, R.color.circle_map_color)))
    ...
    private fun getMapMarker(): BitmapDescriptor {
        ...
        val markerBitmap = Bitmap
            .createBitmap(markerDrawable?.intrinsicWidth!!, markerDrawable.intrinsicHeight, Bitmap.Config.ARGB_8888)
