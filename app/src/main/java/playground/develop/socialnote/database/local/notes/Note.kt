...
class Note(@ColumnInfo(name = "note_title") var noteTitle: String?, @ColumnInfo(name = "note_body") var note: String?, @ColumnInfo(name = "date_created") var dateCreated: Date?, @ColumnInfo(name = "date_modified") var dateModified: Date?, @Embedded(prefix = "location_") var geofence: NoteGeofence? = null, @Embedded(prefix = "preferred_") var timeReminder: NoteReminder? = null, @ColumnInfo(name = "note_category_name") var noteCategory: String? = null) {
